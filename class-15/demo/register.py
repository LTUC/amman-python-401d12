...
## Style theme 
style = ttk.Style() # Initializes the style object
style.theme_use('alt') # Sets the theme to 'alt', which is one of the themes provided by Tkinter
style.configure("TButton", background='#660f9d', foreground='white', width = 20, focuscolor='none')

# Maps the background color to change to a different shade of purple when the button is active (pressed)
...
# Widgets
logo = ImageTk.PhotoImage(Image.open("sign-in-logo.jpg"))
